      ...
      <div className="bg-gray-100 p-8 rounded-lg max-w-4xl w-full flex flex-col md:flex-row">
        <div className="md:w-1/2 p-6">
          ...
          <form className="relative">
            ...
            {passwordError && <p className="text-red-700 font-semibold text-center mb-4">{passwordError}</p>}
            {emailError && <p className="text-red-700 font-semibold text-center mb-4">{emailError}</p>}
          ...
          <p className="mt-4 font-semibold text-center">
            Already have an account? <Link to="/login" className="text-green-800">Sign in</Link>
          </p>
        </div>
